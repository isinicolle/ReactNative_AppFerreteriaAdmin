...
//Pantallas
import { Login,CrearUsuario, AgregarDireccion, Condiciones, HistorialCompra, HistorialDetalle,crearempleado, MisionVision, Privacidad, Inicio, Producto, Config, ConfirmarCorreo, Direcciones, Carrito, Pago, OlvidarContra, RegistroTerminado, Busqueda, InformacionUsuario } from './index';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen name="crearempleado" component={crearempleado}/>
