...
async function conseguirCategoria(id){
    try{
        const res = await fetch('http://192.168.0.10:6001/api/categoria/listarCategoriaPorProducto?idcategoria='+id,
        {method:'GET',
        headers:{
...
async function conseguirMarca(id){
    try{
        const res = await fetch('http://192.168.0.10:6001/api/marca/ProductoPorMarca?idmarca='+id,
        {method:'GET',
        headers:{
          Accept:'application/json',
          'Content-Type':'application/json'
